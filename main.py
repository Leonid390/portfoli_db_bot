...
from telebot.types import InlineKeyboardButton, InlineKeyboardMarkup, ReplyKeyboardMarkup, KeyboardButton, ReplyKeyboardMarkup, ReplyKeyboardRemove
...
def start_command(message):
    '''
    функция для приветсвования пользователя

    параметры
    
    message - сообщение, написанное пользователем
    '''
...
/skills -  используй для добавления навыка к проекту
